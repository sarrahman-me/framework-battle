...
export const options = {
  scenarios: {
    ...
    spike_load: {
      ...
      startVUs: 5, // Mulai dengan 10 pengguna virtual
      stages: [
        { duration: '30s', target: 50 }, // Naik hingga 100 VUs dalam 30 detik
        { duration: '1m', target: 250 },  // Naik hingga 500 VUs dalam 1 menit
